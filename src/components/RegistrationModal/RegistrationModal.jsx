...
const RegistrationModal = ({ isOpen, onClose, type }) => {
  ...
  const [vetData, setVetData] = useState({
    doctorName: '', clinicName: '', mobile: '',
    email: '', city: '', earlyAccess: true,
  });

  const [parentData, setParentData] = useState({
    name: '', mobile: '', email: '',
    city: '', petType: '', hasPet: true, earlyAccess: true,
  });
          ...
          {isVet ? (
            <>
              ...
              <div className="form-checkbox">
                <input type="checkbox" id="vet-early"
            ...
            <>
                ...
                <div className="pet-type-pills">
                  {['dog', 'cat', 'other'].map((pet) => (
                    <label className="pet-pill" key={pet}>
                      <input type="radio" name="petType" value={pet} required
              ...
              <div className="form-checkbox">
                <input type="checkbox" id="parent-have-pet"
              ...
              <div className="form-checkbox">
                <input type="checkbox" id="parent-early"
